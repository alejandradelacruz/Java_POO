/*                         ------------- GESTION AEROPORTUARIA ----------------------
    La aplicacion tendra un menu con las siguientes opciones: 
        1) Consultar los aeropuertos gestionados, indicand separadamente los aeropuertos publicos 
        y los privados. Para cada uno de ellos debera mostrar su nombre, la ciudad de ubicacion, y el 
        pais al que pertenece. 
        2) Visualizar las empresas que patrocinan un determinado aeropuerto en caso que sea
        privado, o la cuantia de la subvencion en caso de que se trate de un aeropuerto publico.
        3) Para un determinado aerpuerto, se debe poder mostrar la lista de compañias que vuelan
        desde ese aeropuerto. 
        4) Para una determinada compañia que operan en un aeropuerto concreto, listar todos los 
        posibles vuelos que dicha compañia ofrece, mostrando su identificador, la ciudad origen y 
        destino y el precio del vuelo.
        5) Mostrar todos los posibles vuelos(indentificador) que parten de una ciudad origen a otra
        ciudad destino(indicadas por el usuario) y mostrar su precio. 
